...
public class UnitTable : MonoBehaviour 
{
    public class Data
    {
        ...
        public Data(CharacterDatabase.Data unit)
        {
            number = unit.number;
        ...
        public Data(MonsterDatabase.Data unit)
        {
            number = unit.number;
        ...
        public void GetUnitTable(CharacterDatabase.Data unit)
        {
            unit.number = number;
        ...
        public void GetUnitTable(MonsterDatabase.Data unit)
        {
            unit.number = number;
